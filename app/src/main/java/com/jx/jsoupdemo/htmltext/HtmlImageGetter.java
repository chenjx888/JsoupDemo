...
//            int widthIndex = attrs.indexOf(widthStr);
//            int widthPx = attrs.indexOf(px);
//            if (widthIndex != -1) {
//                width = Integer.parseInt(attrs.substring(widthIndex + widthStr.length(), widthPx));
//            }
//
//            String heightStr = "height: ";
//            int heightIndex = attrs.indexOf(heightStr);
//            if (widthPx < attrs.length()) {
//                int heightPx = attrs.indexOf(px, widthPx + px.length());
//                if (heightIndex != -1) {
//                    height = Integer.parseInt(attrs.substring(heightIndex + heightStr.length(), heightPx));
//                }
//            }
//
//            LogUtil.e("height=" + height + ",width=" + width);

//            Matcher widthMatcher = IMAGE_WIDTH_PATTERN.matcher(attrs);
//            while (widthMatcher.find()) {
//                LogUtil.e(" widthMatcher 宽度 =" + widthMatcher.group().trim());
